...
#The county with the highest response rate in the 2020 Census was Howard County. The lowest in the 2020 Census was Worcester County.
...
#I think there could be issues because the names in the total population data has Maryland after each county name and the data set of number of large employers does not. I think you could fix this issue by cleaning the data so the county and state were in two different columns and it would be easier to join.
