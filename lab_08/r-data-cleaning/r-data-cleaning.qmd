...
Answer
I would use the mutate function to group all the Maryland entries together and mutate them to all Uppercase MD so when grouped or filtered they could all come up as MD. Cleaning the state column through mutate should give all the data the same value making it easier to work with.
