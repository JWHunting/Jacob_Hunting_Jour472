...
For the first question I would look at answer if there is a correlation between race data and income data in PG County. I would spatial join racial demographic data because of Bowie's rich history and diverse population. I would use census race data and inter join it with the income data to compare.

For the second I would look at the school funding data and look at school budgets in the country and if its different across the more populated schools. I would join budget data and school popualtion to see if there is a correlation between popualtion and funding.
